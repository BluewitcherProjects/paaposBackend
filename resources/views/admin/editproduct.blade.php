                            ...
                            <form class="form-horizontal" method="post" action="{{ route('updateproduct') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" id="Product_name" value="{{$product->name}}" placeholder="Product Name">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="price" class="form-control" id="product_price" value="{{$product->price}}" placeholder="Product Price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <option value="{{ $categor->id }}" selected>{{ $categor->name }}</option>
                                                @else
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="quantity" value="{{$product->quantity}}" id="quantity" placeholder="Stock">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="sku" id="product_discount" value="{{$product->sku}}" placeholder="product sku">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="description" id="summernote1">{{$product->description}}</textarea>
                                            <input type="text" name="descdription" class="product_description"  id="product_description" hidden>
                                        </div>
                                    </div>
