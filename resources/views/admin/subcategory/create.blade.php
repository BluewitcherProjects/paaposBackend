                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('addsubcategory') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" class="form-control" id="category_name" name="category_id" require>
